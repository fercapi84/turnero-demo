...
module.exports = ".scaling-svg-container {\n    position: relative; \n    height: 0; \n    width: 100%; \n    padding: 0;\n    padding-bottom: 17%; \n    /* override this inline for aspect ratio other than square */\n}\n.scaling-svg {\n    position: absolute; \n    height: 100%; \n    width: 100%; \n    left: 0; \n    top: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var profesional1 = {
    ...
    codigoProfesion: 1,
    matriculaProfesional: "16273"
};
var profesional2 = {
    nombreApellido: 'Nuñez, RomanA',
    especialidad: especialidadesMocks,
    codigoProfesion: 1,
    matriculaProfesional: "16274",
};
var profesionalE1 = {
    codigo: 1,
    nombreApellido: 'Perez, Juan',
...
/*!********************************************************!*\
  !*** ./src/app/core/store/actions/contexto.actions.ts ***!
  \********************************************************/
/*! exports provided: CLEAN_STORE, CLEAN_STORE_LOGOUT, CLEAN_STORE_PARCIAL, CLEAN_STORE_PARCIAL_MIN, GET_TOKEN, SET_TOKEN, GET_PASSWORDUSUARIO, SET_PASSWORDUSUARIO, GET_CREDENCIALUSUARIO, SET_CREDENCIALUSUARIO, GET_USUARIO, SET_USUARIO, GET_PACIENTESELECTED, SET_PACIENTESELECTED, GET_TURNOSPACIENTE, SET_TURNOSPACIENTE, SET_TURNOLIBERAR, GET_TURNOSPACIENTERELOAD, cleanStore, cleanStoreParcialMin, cleanStoreParcial, cleanStoreLogout, getToken, setToken, getCredencialUsuario, setCredencialUsuario, getUsuario, setUsuario, getPasswordUsuario, setPasswordUsuario, getPacienteSelected, setPacienteSelected, getTurnosPacienteReload, getTurnosPaciente, setTurnosPaciente, setTurnoLiberar */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CLEAN_STORE", function() { return CLEAN_STORE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CLEAN_STORE_LOGOUT", function() { return CLEAN_STORE_LOGOUT; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cleanStoreLogout", function() { return cleanStoreLogout; });
...
var CLEAN_STORE_LOGOUT = '[Contexto] - cleanStoreLogout';
...
var cleanStoreLogout = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])(CLEAN_STORE_LOGOUT);
...
var _cleanLogout = function (state) {
    var stateNew = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, state);
    stateNew.token = undefined;
    //esAnonimo: true,
    //credencial: undefined,
    stateNew.infoUsuario = undefined;
...
}), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_contexto_actions__WEBPACK_IMPORTED_MODULE_2__["cleanStoreLogout"], function (state) {
    return _cleanLogout(state);
...
var _setProfesionales = function (state, profesionales) {
    ...
    if (state.profesionalSelected != undefined &&
        state.profesionalSelected.codigoProfesion != undefined) {
        var limpiar = true;
        profesionales.forEach(function (pp) {
            if (pp.codigoProfesion == state.profesionalSelected.codigoProfesion &&
                pp.matriculaProfesional == state.profesionalSelected.matriculaProfesional) {
                limpiar = false;
            }
        });
        if (limpiar) {
...
module.exports = ".mat-option {\n    margin: 1rem 0;\n    overflow: visible;\n    line-height: initial;\n    word-wrap: break-word;\n    white-space: pre-wrap;\n    height: unset;\n  }\n\n  section {\n    display: table;\n    margin: 8px;\n  }\n\n  table {\n    width: 100%;\n}\n\n  /* Structure */\n\n  .example-container {\n    position: relative;\n}\n\n  .example-table-container {\n    position: relative;\n    max-height: 400px;\n    overflow: auto;\n}\n\n  table {\n    width: 100%;\n}\n\n  .example-loading-shade {\n    position: absolute;\n    top: 0;\n    left: 0;\n    bottom: 56px;\n    right: 0;\n    background: rgba(0, 0, 0, 0.15);\n    z-index: 1;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n}\n\n  .example-rate-limit-reached {\n    color: #980000;\n    max-width: 360px;\n    text-align: center;\n}\n\n  /* Column Widths */\n\n  .mat-column-number, .mat-column-state {\n    max-width: 64px;\n}\n\n  .mat-column-created {\n    max-width: 124px;\n}\n\n  .material-icons{\n    color: #1061a7 !important;\n}\n\n  .texto {\n    line-height:26px;\n}\n\n  .mat-cell.ng-star-inserted:hover {\n    background-color: #e2e2e2 !important;\n}\n\n  .mat-radio-button {\n    margin-left: 10px;\n}\n\n  ::ng-deep .mat-radio-button.mat-accent .mat-radio-ripple .mat-ripple-element {\n    opacity: 0.0 !important;     /*click effect color change*/\n    background-color: #1061a7 !important;\n}\n\n  ::ng-deep .mat-radio-button.mat-accent .mat-radio-inner-circle {\n    background-color: #1061a7 !important;   /*inner circle color change*/\n}\n\n  ::ng-deep.mat-radio-button.mat-accent.mat-radio-checked .mat-radio-outer-circle {\n    border-color: #1061a7 !important; /*outer ring color change*/\n}\n\n  td.mat-cell:first-of-type, td.mat-footer-cell:first-of-type, th.mat-header-cell:first-of-type {\n    padding-left: 5px;\n}\n\n  td.mat-cell, td.mat-footer-cell, th.mat-header-cell {\n    padding-left: 5px;\n}\n\n  .mat-icon-button {\n    width: 25px;\n}\n\n  .material-icons {\n    vertical-align: middle;\n}\n\n  .button-a {\n    background-color: #ffffff;\n    color: var(--font);\n}\n\n  .button-a:hover {\n    background-color: #ffffff;\n    color: var(--azul);\n}\n\n  @media(max-width: 800px) {\n    .unique-button {\n        width: 86%;\n        margin-right: 8px;\n        margin-left: 8px;\n    }\n}\n\n  @media(min-width: 799px) {\n    .unique-button {\n        width: 88%;\n        margin-right: 4%;\n        margin-left: 4%;\n    }\n}\n\n  @media(max-width: 800px) {\n    .two-button {\n        width: 42%;\n        margin-right: 8px;\n        margin-left: 8px;\n    }\n}\n\n  @media(min-width: 799px) {\n    .two-button {\n        width: 40%;\n        margin-right: 4%;\n        margin-left: 4%;\n    }\n}\n\n  @media(max-width: 800px) {\n    .one-button {\n        width: 45%;\n        margin-right: 2%;\n        margin-left: 2%;\n    }\n}\n\n  @media(min-width: 799px) {\n    .one-button {\n        width: 35%;\n        margin-right: 2%;\n        margin-left: 2%;\n    }\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoginPageComponent = /** @class */ (function () {
    function LoginPageComponent(dialog, store, router) {
        ...
        this.displayedColumnsT = ['acciones', 'fecha', 'especialidad'];
        ...
        this.subscription2 = this.store.select(_core_store_selectors_contexto_selectors__WEBPACK_IMPORTED_MODULE_11__["getPacientes"]).subscribe(function (pp) {
            if (pp && pp.length > 0) {
                _this.seleccionar(pp[0]);
    ...
    LoginPageComponent.prototype.logoutPaciente = function () {
        ...
        this.store.dispatch(_core_store_actions_contexto_actions__WEBPACK_IMPORTED_MODULE_7__["cleanStoreLogout"]());
    };
                ...
                _this.store.select(_core_store_selectors_contexto_selectors__WEBPACK_IMPORTED_MODULE_11__["getCredencial"]).subscribe(function (c) {
                    if (c != undefined) {
                        var req = req = {
                            ...
                            codigoTurnoEstudio: undefined
                        };
                        if (turno.profesionalEspecialidad != undefined && turno.profesionalEspecialidad.codigo != undefined) {
                            req.codigoTurno = turno.codigo;
                        }
                        else if (turno.servicio != undefined && turno.servicio.codigo != undefined) {
                            req.codigoTurnoEstudio = turno.codigo;
                        }
...
module.exports = __webpack_require__(/*! /home/pato/entornos/amr/turneroFC/turnero/turnero-hospital-espaniol/src/main.ts */"./src/main.ts");
